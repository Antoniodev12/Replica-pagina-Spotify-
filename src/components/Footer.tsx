    ...
    return(
      <footer className="bg-zinc-900 border-t border-zinc-700 p-6 flex items-center justify-between">
        <div className='flex items-center gap-3'>
          <Image src="/cd-nx.jpg" width={56} height={56} alt="DragonForce"/>
          <div className='flex flex-col'>
            <strong className='font-normal'>Pela Última Vez</strong>
            <span className='text-xs text-zinc-400'>NX-Zero</span>
          </div>
        </div>
